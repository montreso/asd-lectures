\ifhandouts
\documentclass[t,handout,notes,colorlinks]{beamer}
\fi
\ifslides
\documentclass[t,colorlinks]{beamer}
\geometry{paperwidth=128.00mm, paperheight=96mm}
\fi
\ifwide
\documentclass[t,colorlink]{beamers}
\geometry{paperwidth=153.6mm, paperheight=96mm}
\fi
\ifnotes
\documentclass[t,handout,notes=onlyslideswithnotes,colorlinks]{beamer}
\fi
...
\newenvironment{OnlySlides}[2][shrink,noframenumbering]{
	\setbeamertemplate{headline}
	{
	  \leavevmode%
	  \hbox{%
