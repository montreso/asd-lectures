...
%-------------------------------------------------------------------------
\begin{frame}{Due parole su di me}

\TwoColsCustom{0.60}{0.37}{
\BIL
\item Titolare di due corsi:\\[6pt]
\BIL
\item \alert{Algoritmi e Strutture Dati}\\
LT Informatica (+LT ICE, LT MAT)
\item \alert{Laboratory of Computer Science Education}\\
  LM Computer Science, LM AIS
\EIL
\item Highlights\\[6pt]
\BIL
\item Senatore accademico + 9 altre cariche
\item Co-fondatore Coderdojo Verona
\item Co-fondatore FabLab UniTrento
\EIL
\EIL
}{
\vspace{-12pt}
...
\textbf{Input}: un vettore di interi $A$, di $n$ elementi\\[6pt]
\textbf{Output}: il \alert{sottovettore contiguo} $A[i \ldots j]$ di \alert{somma massimale},
...
\fbox{\includegraphics[width=0.8\textwidth]{stackoverflow.jpg}}
}{
\sout{Cerco qualcosa su StackOverflow}\\
Chiedo a ChatGPT\\
(CODE MONKEY)
}
...
\vspace{-9pt}
\begin{myboxtitle}[Problema: Sottovettore di somma massimale]
\textbf{Input}: un vettore contenente $n$ interi $A$\\[6pt]
\textbf{Output}: il \alert{sottovettore contiguo} $A[i \ldots j]$ di \alert{somma massimale},
ovvero il sottovettore la cui somma degli elementi $\sum_{k=i}^j A[k]$ è
più grande o uguale alla somma degli elementi di qualunque altro sottovettore.
\end{myboxtitle}
...
\BIL
\item Dividiamo il vettore in due parti più o meno uguali
...
\item L'algoritmo proposto è corretto?
\EIL
\end{myboxtitle}
...
Sia \alert{$\mathit{maxHere}_i$} il valore del sottovettore di somma massima che termina in posizione $A[i]$

\[
\mathit{maxHere}_{i} = \begin{cases}
  \max(A[0], 0) & i=0 \\
  \max(\mathit{maxHere}_{i-1}+A[i], 0) & i > 0
\end{cases}
\]
...
\BB{Il valore massimo contenuto in $\mathit{maxHere}_0 \ldots \mathit{maxHere}_{n-1}$ rappresenta il valore del sottovettore di somma massima che termina in una qualunque posizione del vettore, quindi la nostra risposta.
}
...
\BI
\item Un corso \alert{annuale} da 12 crediti (da 09/2023 a 05/2024), suddiviso in due moduli, ma con un unico esame orale finale
\EI
\end{myboxtitle}

\begin{myboxtitle}[Studenti Matematica, Inf. Org., ICE]
\BI
\item Scelta fra versione 6 crediti (uno per semestre) o versione da 12 crediti.
\EI
\end{myboxtitle}
...
\item Problemi intrattabili
	...
	\item Tecniche euristiche, approssimate
	\EI
\EIL
\end{myboxtitle}
\end{column}
...
\BI
\item \alert{Conoscenze}: panoramica sui problemi fondamentali e le loro soluzioni algoritmiche
...
\item Analizzate le vostre soluzioni
\item Implementatele!
\EI
\end{myboxtitle}
}
...
\vspace{-18pt}
\epigraph{\alert{Chiedi, e ti vergognerai un attimo, non chiedere e ti vergognerai per sempre}
}{\textit{Murakami Haruki\\Kafka sulla spiaggia}}
}{
\setlength\epigraphwidth{.90\textwidth}
\vspace{-18pt}
...
\BI
\item Partecipare in 150+ è difficile, ma cercate di partecipare tutti
\EI
\end{myboxtitle}
\end{frame}
...
\url{https://forms.gle/37B4q9h19ptwKHzK7}
\item Canale Telegram (annunci, parlo io):\\
\url{https://t.me/unitn_asd23}
\item Gruppo telegram (discussione, parlate voi):
\url{https://t.me/+fr8ck2Cah5NlMDJk}
\EIL
...
%-------------------------------------------------------------------------
\begin{frame}{Sull'uso di portatili e smartphone durante la lezione}

\begin{columns}[T]

\column{0.35\textwidth}
\BB{Smartphone in modalità aereo}
...
\BI
\item Cormen, Leiserson, Rivest, Stein. \alert{\emph{Introduction to Algorithms}}. \\The MIT Press; $4^{\textrm{th}}$ ed. (2022) (\euro 103.28)
\item Cormen, Leiserson, Rivest, Stein. \alert{\emph{Introduction to Algorithms}}. \\The MIT Press; $3^{\textrm{rd}}$ ed. (2009) (\euro 48.73)
\item Jon Kleinberg, Eva Tardos. \alert{\emph{Algorithm Design}}. \\Addison Wesley, $1^{\textrm{st}}$ Int. ed. (2013) (\euro 94.99)
\EI
\end{myboxtitle}
...
\begin{tabular}{|l|l|l|}
\hline
Martedì & 10.30 -- 12.30 & Lezione/Esercitazione \\\hline
Giovedì & 13.30 -- 15.30 & Lezione/Esercitazione \textbf{or} Lab \\\hline
\end{tabular}
\end{myboxtitle}

\begin{myboxtitle}[Ricevimento]
\BI
\item Via zoom, annunciato settimanalmente\\
...
\BI
\item \alert{Salto appello}: in ogni anno solare (2024, 2025):
\BI
...
\BI
\item Progetto 1: Dicembre 2023 [0-3] punti
\item Progetto 2: Maggio 2024 [0-3] punti
\EI
\EI
\end{myboxtitle}
...
\tiny
\begin{align*}
  \mathrm{12\ crediti} & \qquad \frac{(\textrm{Voto Scritto 1 + BonusLab 1}) + (\textrm{Voto Scritto 2 + BonusLab2 })}{2} \geq 17.5 \\
...
\vspace{-9pt}
\TwoCols{
\begin{myboxtitle}[Studenti 2023-24]
\begin{tabular}{|l|l|}
\hline
\textbf{Parte A} & \textbf{Parte B} \\\hline
01/2024 & \\\hline
02/2024 &  \\\hline
06/2024 & {06/2024} \\\hline
07/2024 & {07/2024} \\\hline
09/2024 & {09/2024} \\\hline
  & {01/2025} \\\hline
 & {02/2025} \\\hline
\end{tabular}
\end{myboxtitle}
...
01/2024 & 01/2024\\\hline
02/2024 & 02/2024 \\\hline
06/2024 & {06/2024} \\\hline
07/2024 & {07/2024} \\\hline
09/2024 & {09/2024} \\\hline
\end{tabular}
...
\item Fabrizio Sandri (2022)
\item Emanuele Grisenti (2022)
\item Sebastiono Tocci (2023)
\EI
\end{myboxtitle}
}
