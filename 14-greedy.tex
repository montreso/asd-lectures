...
\smallskip
\makebox[2.8cm][l]{Sappiamo che:} \alert{$a_m<b_m$} \hfill (Definizione di intervallo)

\smallskip
\makebox[2.8cm][l]{Sappiamo che:} \alert{$\forall k \in S[i,j]: b_m \leq b_k$} \hfill ($m$ ha minor tempo di fine)

\smallskip
\makebox[2.8cm][l]{Ne consegue che:} \alert{$\forall k \in S[i,j]: a_m < b_k$} \hfill (Transitività)
