...
%
\draw[edgen] (a) edge[above left] node[rounded corners=2pt,fill=red!10] {\R{2}/\B{2}} (b);
\draw[edgen] (b) edge[below,dashed,bend left=25] node[rounded corners=2pt,fill=red!10] {\R{-2}/\B{0}} (a);
