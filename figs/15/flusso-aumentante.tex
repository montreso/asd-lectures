...
\draw[edger] (b) edge[below,dashed,bend left=25] node[rounded corners=2pt,fill=red!10] {\R{-2}/\B{0}} (a);
...
\draw[edger] (e) edge[below,dashed,bend left=25] node[rounded corners=2pt,fill=red!10] {\R{-2}/\B{0}} (b);
...
\draw[edger] (f) edge[above,dashed,bend right=25] node[rounded corners=2pt,fill=red!10] {\R{-2}/\B{0}} (e);
\end{tikzpicture}
