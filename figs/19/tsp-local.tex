...
\draw[edger, ultra thick,-] (1) edge node[fill=white,circle,inner sep=0] {3} (2);
...
\draw[edger, ultra thick,-] (1) edge node[fill=white,circle,inner sep=0] {7} (5);
...
\draw[edger, ultra thick,-] (4) edge node[fill=white,circle,inner sep=0] {6} (5);
...
\draw[edgen, thick,-] (2) edge node[fill=white,circle,inner sep=0] {6} (4);
\draw[edgen, thick,-] (2) edge node[fill=white,circle,inner sep=0] {3} (5);
\draw[edgen, dashed, thick,-] (3) edge node[fill=white,circle,inner sep=0] {5} (4);
\draw[edgen, thick,-] (3) edge node[fill=white,circle,inner sep=0] {8} (5);
\draw[edger, ultra thick,-] (4) edge node[fill=white,circle,inner sep=0] {6} (5);
...
\draw[edger, ultra thick,-] (3) edge node[fill=white,circle,inner sep=0] {8} (5);
\draw[edger, ultra thick,-] (4) edge node[fill=white,circle,inner sep=0] {6} (5);
...
\draw[edger, ultra thick,-] (1) edge node[fill=white,circle,inner sep=0] {4} (3);
\draw[edger, ultra thick,-] (1) edge node[fill=white,circle,inner sep=0] {2} (4);
\draw[edgen, thick,-] (1) edge node[fill=white,circle,inner sep=0] {7} (5);
\draw[edger, ultra thick,-] (2) edge node[fill=white,circle,inner sep=0] {4} (3);
\draw[edgen, thick,-] (2) edge node[fill=white,circle,inner sep=0] {6} (4);
