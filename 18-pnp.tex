...
\vspace{-9pt}
\begin{myboxtitle}[Soddisfattibilità di formule booleane ((\textsc{SATisfiability}))]
...
\vspace{-9pt}
\begin{myboxtitle}[Cricca (Clique)]
...
\vspace{-9pt}
\begin{myboxtitle}[Commesso viaggiatore (Traveling salesperson - TSP)]
...
\vspace{-9pt}
\begin{myboxtitle}[Copertura esatta di insiemi (Exact cover)]
